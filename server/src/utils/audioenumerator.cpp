...
std::vector<AudioDeviceInfo> AudioEnumerator::enumerateDevices()
{
  ...
  catch(const std::exception& e)
  {
    ...
    Log::log("AudioEnumerator", LogMessage::I1006_X, std::string("Audio enumeration error: ") + e.what());
  }
...
void AudioEnumerator::logDeviceInfo()
{
  ...
  Log::log("AudioEnumerator", LogMessage::I1006_X, std::string("=== Windows Audio Devices (WASAPI) ==="));
  Log::log("AudioEnumerator", LogMessage::I1006_X, std::string("Found ") + std::to_string(devices.size()) + " audio output device(s)");
  ...
  for(size_t i = 0; i < devices.size(); i++)
  {
    ...
    Log::log("AudioEnumerator", LogMessage::I1006_X, deviceHeader);
    
    // Log each channel
    for(const auto& channel : device.channels)
    {
      Log::log("AudioEnumerator", LogMessage::I1006_X, 
        std::string("  Channel ") + std::to_string(channel.channelIndex) + ": " + channel.channelName);
    }
  }
  
  Log::log("AudioEnumerator", LogMessage::I1006_X, std::string("=== End Audio Device List ==="));
}
...
void AudioEnumerator::logDeviceInfo()
{
  Log::log("AudioEnumerator", LogMessage::I1006_X, std::string("Audio enumeration not implemented for this platform"));
}
